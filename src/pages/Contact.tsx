...
export const Contact: React.FC = () => {
	...
	const inputClass =
		'w-full px-4 py-3 bg-gray-900 border border-gray-500 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors';
		...
		<div className="min-h-screen bg-gray-900 flex flex-col">
			<div className="flex-1 flex items-center justify-center px-4 py-24 sm:py-32">
				<div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
					...
					>
						<div className="relative inline-block py-8 px-8 mb-8">
							...
							<h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight">
								Let's capture
								<br />
								<span className="text-blue-400">something</span> neat
							</h1>
						</div>
						...
						<div className="space-y-5">
							...
							>
								<div className="w-10 h-10 bg-gray-800 border border-gray-700 rounded-lg flex items-center justify-center group-hover:border-gray-500 transition-colors flex-shrink-0 text-gray-400">
					...
					>
						<div className="bg-gray-800 border border-gray-700 rounded-2xl p-8 sm:p-10 shadow-xl shadow-blue-950/30">
							{isSubmitted ? (
								<motion.div
