	...
	return (
		<div className="min-h-screen bg-gray-900 flex flex-col">
			...
			>
				...
				>
					<div className="w-10 h-10 bg-gray-800 border border-gray-700 rounded-lg flex items-center justify-center group-hover:border-gray-500 transition-colors text-gray-400 group-hover:text-white">
