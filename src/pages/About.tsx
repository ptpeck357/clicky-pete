								...
								<div className="mt-2">
									<div>
										...
										<div className="ml-4 text-gray-300 leading-relaxed text-xs sm:text-sm">
											...
											camera to use. So I started taking hundreds of bad photos. You could say I
											became "clicky-happy" with the shutter release. How can you not when you
											grew up in Montana???
											<br />
											<br />
											...
											or playing pickup sports like ultimate frisbee, disc golf, volleyball, and
